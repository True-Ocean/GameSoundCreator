...
- [x] **3.5-C** フィルタ＋短い残響
- [ ] **3.5-D** 簡易FM＋レイヤー割当の整理
- [ ] （任意）**3.5-E** オルガン／ギター等の追加
...
- [x] 音色を変えると聴感が大きく違う
- [ ] 8ビット一色ではなく、レトロ〜初期インディー寄りの印象になる
- [ ] メロディに覚えられる短い塊があり、別パターンで型の差が分かる
...
1. **Phase 3.5-M1** — メロディ作曲第一弾（モチーフ＋リズム型＋輪郭）  
2. **Phase 3.5-D** — 簡易FM＋レイヤー割当  
3. 問題なければ **Phase 4**（ピクセルバトル投入）  
