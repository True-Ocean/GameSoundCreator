...
struct InstrumentPalette: Sendable {
    ...
    static func from(instrumentId: String) -> InstrumentPalette {
        ...
        case .guitar:
            // Adventure pluck: saw bite on attack, then rounded string ring.
            return InstrumentPalette(
                chordShape: .triangle,
                bassShape: .triangle,
                leadShape: .saw,
                chordEnv: ADSR(attack: 0.003, decay: 0.26, sustain: 0.12, release: 0.18),
                bassEnv: ADSR(attack: 0.005, decay: 0.14, sustain: 0.35, release: 0.12),
                leadEnv: ADSR(attack: 0.002, decay: 0.32, sustain: 0.08, release: 0.2),
                chordAmpScale: 0.9,
                bassAmpScale: 0.9,
                leadAmpScale: 1.2,
                chordDurationScale: 1.05,
                ...
                filterCutoffScale: 0.98,
                reverbMixBias: 0.08,
                chordFM: FMTone(ratio: 2.0, index: 0.28),
                bassFM: FMTone(ratio: 1.0, index: 0.2),
                leadFM: FMTone(ratio: 2.0, index: 0.5),
                drumAmpScale: 0.8,
                chordUpperAtten: 0.2,
                bassRootHeavy: true,
                hatAmpScale: 0.7,
                chordTail: ToneTail(ringOut: 0.18, fmDecay: 0.08),
                bassTail: .none,
                leadTail: ToneTail(ringOut: 0.28, fmDecay: 0.1),
                pianoVoice: false
            )
        }
    }
